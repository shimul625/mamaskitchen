...
<html lang="en">
    ...
    <body data-spy="scroll" data-target="#template-navbar">
        ...
        <script type="{{asset('frontend/text/javascript" src="js/jquery.hoverdir.js')}}"></script>
        <script type="{{asset('frontend/text/javascript" src="js/jQuery.scrollSpeed.js')}}"></script>
